<?php
/**
 * Template Name: Certificate Success
 * Certificate Success Page Template
...
if (isset($_GET['session_id'])) {
    ...
    if ($stripe_secret_key) {
        ...
        try {
            ...
            if (!$existing_cert && $session->payment_status === 'paid') {
            ...
            } else if ($existing_cert) {
                error_log('Certificate already exists for session: ' . $session_id);
            }
        } catch (Exception $e) {
            // Log error but don't show to user
            error_log('Error processing certificate on success page: ' . $e->getMessage());
        }
    }
}
?>
