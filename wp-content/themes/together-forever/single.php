...
<main id="main" class="site-main single-post">
    <?php while (have_posts()) : the_post(); ?>
        ...
        if ($featured_image_url) : ?>
            <section class="single-post-hero" style="background-image: url('<?php echo esc_url($featured_image_url); ?>');">
        ...
        <?php else : ?>
            <!-- No Featured Image - Show Header Section -->
            <section class="single-post-header">
                <div class="container">
                    <div class="header-content">
                        ...
                        <h1 class="single-post-title-header"><?php the_title(); ?></h1>
